    ...
    <section className="bg-primary-violet">
      <div className="container flex justify-center items-center flex-col min-h-[448px]">
        <div className="w-full flex justify-between ">
          <div className=" bg-primary-cyan p-8 rounded-3xl flex justify-center gap-5 min-w-[300px] ">
          ...
          <div className=" bg-primary-pink p-8 rounded-3xl flex justify-center gap-5 min-w-[300px] ">
